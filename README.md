...
Luego de clonar el repositorio, es necesario installar las librerias que permitiran usar las funciones del archivo main.py. Ejecutar la siguiente línea en la consula del entorno virtual del proyecto.
